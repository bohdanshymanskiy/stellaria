// Shared copy — Stellaria™ (Deep Space Pharma)

window.STELLARIA_COPY = {
  banner: {
    eyebrow: "Rx Only",
  ...
  email: {
    ...
    preheader: "Indicated for hibernation-assist on missions ≥ 90 days. Please see full prescribing information.",
    heroEyebrow: "Now available for Fleet Medical formularies",
    heroHeadline: "Clarity on arrival.",
    heroBody: "Stellaria™ (morphanidine-C) is a prescription hibernation-assist tablet indicated for cryo-induction support in licensed deep-space personnel on missions of 90 days or longer. In the pivotal ORION-3 trial, pilots administered Stellaria prior to cryosleep reported a 94% reduction in post-thaw cognitive fog versus placebo at T+0:30.",
    cta: "Learn More",
    benefits: [
    ...
    footerUnsub: "You received this because you are a licensed healthcare provider on the DSP Fleet Medical list. Unsubscribe or update preferences.",
    footerLegal: "© 2095 Deep Space Pharma. STELLARIA and the DSP travel mark are trademarks of Deep Space Pharma. STL-PI-2095-03.",
  },
  ...
  isi: {
    ...
    sections: [
      ...
      { heading: "Warnings and Precautions",
        body: "Cardiac effects: see Boxed Warning. Hypothalamic set-point drift has been reported during first-exposure inductions; monitor core temperature for 90 minutes post-thaw. Neuro-vestibular effects, including transient orientation loss, may occur on re-animation; patients should not perform EVA duties for 120 minutes post-thaw. Dependence: Stellaria has demonstrated low physical dependence liability; however, psychological dependence has been reported with off-label chronic use outside cryo-induction protocols." },
      { heading: "Adverse Reactions",
        body: "Most common adverse reactions (≥ 5%, vs. placebo) in the ORION-3 trial were: dry mouth (11%), mild paresthesia of the extremities during re-animation (9%), transient temporal displacement (7%), metallic taste (6%), and mild photosensitivity for up to 24 hours post-thaw (5%). Less common (< 1%): vivid stasis dreaming, brief spatial inversion, subclinical ion trail after-imaging." },
      ...
      { heading: "Use in Specific Populations",
        body: "Pregnancy: contraindicated; morphanidine-C crosses the placental barrier with unknown effects on fetal cryo-tolerance. Lactation: not recommended; discontinue nursing or withhold Stellaria. Pediatric use: safety and effectiveness not established in patients under 21 years. Geriatric use: no dose adjustment in patients 65–80; not studied above 80 years. Hepatic/renal impairment: reduce dose by 50% in moderate impairment; contraindicated in severe." },
